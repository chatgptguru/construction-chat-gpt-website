                                    ...
                                    <div class="box-icon-simple left">
                                        <div class="text">
                                            <ul class="page_content_ul">
                                                <li id="dislamier_content_1">
                                                    The information provided on this website is generated by ChatGPT and GPT-3, advanced language processing models developed by OpenAI. </li>
                                                <li id="dislamier_content_2">
                                                    While every effort has been made to ensure the accuracy and reliability of the information provided, we cannot guarantee that it is free from errors or omissions.
                                                </li>
                                                <li id="dislamier_content_3">
                                                    Use of the information on this website is at the user's own risk, and the website's owners and operators will not be held responsible for any loss or damage arising from the use of the information provided.
                                                </li>
